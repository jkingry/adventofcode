...
module Day16 =
    ...
    let bitsToString (bits: System.Collections.BitArray) =
    ...
    let reverseBitArray (ba: System.Collections.BitArray) =
    ...
    let dragonCurve (a: System.Collections.BitArray) =
        let mutable b = reverseBitArray a
    ...
    let run (input: byte array) (output: int -> string -> unit) =
        ...
        let fill targetLength =
            let mutable a = System.Collections.BitArray initial
        ...
        fill 272 |> checksum |> bitsToString |> output 1

        fill 35651584 |> checksum |> bitsToString |> output 2
